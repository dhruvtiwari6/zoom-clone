...
class UserActions(Generic[_PrismaModelT]):
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group User records by avatar_url values
...
class MeetingActions(Generic[_PrismaModelT]):
    __slots__ = (
        '_client',
        '_model',
    )
    ...
    async def query_raw(
        ...
        *args
        ...
        -------
        ```py
        users = await Meeting.prisma().query_raw(
    ...
    async def query_first(
        ...
        *args
        ...
        -------
        ```py
        user = await Meeting.prisma().query_first(
    ...
    async def create(
        self,
        data: types.MeetingCreateInput,
        include: Optional[types.MeetingInclude] = None
    ) -> _PrismaModelT:
        ...
        data
            Meeting record data
        include
            Specifies which relations should be loaded on the returned Meeting model
        ...
        -------
        ```py
        # create a Meeting record from just the required fields
        meeting = await Meeting.prisma().create(
            data={
                # data to create a Meeting record
                'meeting_id': 'bgeecijdgg',
                'host_id': 1388290519,
                'passcode': 'bgehebiafc',
            },
        )
    ...
    async def create_many(
        self,
        data: List[types.MeetingCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> int:
        """Create multiple Meeting records at once.
        ...
        -------
        ```py
        total = await Meeting.prisma().create_many(
            data=[
                {
                    # data to create a Meeting record
                    'meeting_id': 'bghffegacj',
                    'host_id': 1767274722,
                    'passcode': 'dcgchcbbf',
                },
                {
                    # data to create a Meeting record
                    'meeting_id': 'bdedcabahc',
                    'host_id': 675780521,
                    'passcode': 'heejgedji',
                },
            ],
    ...
    async def delete(
        self,
        where: types.MeetingWhereUniqueInput,
        include: Optional[types.MeetingInclude] = None
    ) -> Optional[_PrismaModelT]:
        ...
        ----------
        where
            Meeting filter to select the record to be deleted, must be unique
        include
            Specifies which relations should be loaded on the returned Meeting model
        ...
        -------
        ```py
        meeting = await Meeting.prisma().delete(
            where={
                'id': 1969681615,
            },
        )
    ...
    async def find_unique(
        ...
        """Find a unique Meeting record.

        Parameters
        ----------
        where
            Meeting filter to find the record, must be unique
        include
            Specifies which relations should be loaded on the returned Meeting model
        ...
        -------
        ```py
        meeting = await Meeting.prisma().find_unique(
            where={
                'id': 1116175964,
            },
        )
    ...
    async def find_unique_or_raise(
        ...
        """Find a unique Meeting record. Raises `RecordNotFoundError` if no record is found.
        ...
        -------
        ```py
        meeting = await Meeting.prisma().find_unique_or_raise(
            where={
                'id': 861472101,
            },
        )
    ...
    async def find_many(
        ...
        take: Optional[int] = None,
        skip: Optional[int] = None,
        where: Optional[types.MeetingWhereInput] = None,
        cursor: Optional[types.MeetingWhereUniqueInput] = None,
        include: Optional[types.MeetingInclude] = None,
        order: Optional[Union[types.MeetingOrderByInput, List[types.MeetingOrderByInput]]] = None,
        distinct: Optional[List[types.MeetingScalarFieldKeys]] = None,
    ) -> List[_PrismaModelT]:
        """Find multiple Meeting records.
        ...
        ----------
        take
            Limit the maximum number of Meeting records returned
        skip
            Ignore the first N results
        where
            Meeting filter to select records
        cursor
            Specifies the position in the list to start returning results from, (typically an ID field)
        include
            Specifies which relations should be loaded on the returned Meeting model
        order
            Order the returned Meeting records by any field
        distinct
            Filter Meeting records by either a single distinct field or distinct combinations of fields

        Returns
        -------
        List[prisma.models.Meeting]
            The list of all Meeting records that could be found
        ...
        -------
        ```py
        # find the first 10 Meeting records
        meetings = await Meeting.prisma().find_many(take=10)

        # find the first 5 Meeting records ordered by the title field
        meetings = await Meeting.prisma().find_many(
            take=5,
            order={
                'title': 'desc',
            },
    ...
    async def find_first(
        ...
        skip
            Ignore the first N records
        where
            Meeting filter to select the record
        cursor
            Specifies the position in the list to start returning results from, (typically an ID field)
        include
            Specifies which relations should be loaded on the returned Meeting model
        ...
        -------
        prisma.models.Meeting
            The first Meeting record found, matching the given arguments
        None
            No record could be found
        ...
        -------
        ```py
        # find the second Meeting record ordered by the description field
        meeting = await Meeting.prisma().find_first(
            skip=1,
            order={
                'description': 'desc',
            },
    ...
    async def find_first_or_raise(
        ...
        """Find a single Meeting record. Raises `RecordNotFoundError` if no record was found.
        ...
        -------
        ```py
        # find the second Meeting record ordered by the host_id field
        meeting = await Meeting.prisma().find_first_or_raise(
            skip=1,
            order={
                'host_id': 'desc',
            },
    ...
    async def update(
        ...
        ----------
        data
            Meeting record data specifying what to update
        where
            Meeting filter to select the unique record to create / update
        include
            Specifies which relations should be loaded on the returned Meeting model
        ...
        -------
        ```py
        meeting = await Meeting.prisma().update(
            where={
                'id': 1303003706,
            },
            data={
                # data to update the Meeting record to
            },
        )
        ```
        """
    ...
    async def upsert(
        ...
        -------
        prisma.models.Meeting
            The created or updated Meeting record
        ...
        -------
        ```py
        meeting = await Meeting.prisma().upsert(
            where={
                'id': 1686638315,
            },
            data={
    ...
    async def update_many(
        self,
        data: types.MeetingUpdateManyMutationInput,
        where: types.MeetingWhereInput,
    ) -> int:
        """Update multiple Meeting records

        Parameters
        ----------
        data
            Meeting data to update the selected Meeting records to
        where
            Filter to select the Meeting records to update

        Returns
        -------
        int
            The total number of Meeting records that were updated
        ...
        -------
        ```py
        # update all Meeting records
        total = await Meeting.prisma().update_many(
            data={
                'status': 'caaaedabfc'
            },
            where={}
    ...
    async def count(
        ...
        """Count the number of Meeting records present in the database

        Parameters
        ----------
        select
            Select the Meeting fields to be counted
        take
            Limit the maximum result
        skip
            Ignore the first N records
        where
            Meeting filter to find records
        cursor
            Specifies the position in the list to start counting results from, (typically an ID field)
        order
            This parameter is deprecated and will be removed in a future release
        ...
        prisma.types.MeetingCountAggregateOutput
            Data returned when `select` is used, the fields present in this dictionary will
            match the fields passed in the `select` argument
        ...
        ```py
        # total: int
        total = await Meeting.prisma().count()

        # results: prisma.types.MeetingCountAggregateOutput
        results = await Meeting.prisma().count(
            select={
                '_all': True,
                'scheduled_at': True,
            },
    ...
    async def count(
        self,
        select: types.MeetingCountAggregateInput,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        where: Optional[types.MeetingWhereInput] = None,
        cursor: Optional[types.MeetingWhereUniqueInput] = None,
    ) -> types.MeetingCountAggregateOutput:
        ...

    async def count(
        self,
        select: Optional[types.MeetingCountAggregateInput] = None,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        where: Optional[types.MeetingWhereInput] = None,
        cursor: Optional[types.MeetingWhereUniqueInput] = None,
    ) -> Union[int, types.MeetingCountAggregateOutput]:
        """Count the number of Meeting records present in the database
        ...
        if select is None:
            ...
            return cast(types.MeetingCountAggregateOutput, resp['data']['result']['_count'])

    async def delete_many(
        self,
        where: Optional[types.MeetingWhereInput] = None
    ) -> int:
        """Delete multiple Meeting records.

        Parameters
        ----------
        where
            Optional Meeting filter to find the records to be deleted

        Returns
        -------
        int
            The total number of Meeting records that were deleted
        ...
        total = await Meeting.prisma().delete_many()
        ```
        """
        resp = await self._client._execute(
            method='delete_many',
    ...
    async def group_by(
        self,
        by: List['types.MeetingScalarFieldKeys'],
        *,
        where: Optional['types.MeetingWhereInput'] = None,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        avg: Optional['types.MeetingAvgAggregateInput'] = None,
        sum: Optional['types.MeetingSumAggregateInput'] = None,
        min: Optional['types.MeetingMinAggregateInput'] = None,
        max: Optional['types.MeetingMaxAggregateInput'] = None,
        having: Optional['types.MeetingScalarWhereWithAggregatesInput'] = None,
        count: Optional[Union[bool, 'types.MeetingCountAggregateInput']] = None,
        order: Optional[Union[Mapping['types.MeetingScalarFieldKeys', 'types.SortOrder'], List[Mapping['types.MeetingScalarFieldKeys', 'types.SortOrder']]]] = None,
    ) -> List['types.MeetingGroupByOutput']:
        """Group Meeting records by one or more field values and perform aggregations
        each group such as finding the average.

        Parameters
        ----------
        by
            List of scalar Meeting fields to group records by
        where
            Meeting filter to select records
        take
            Limit the maximum number of Meeting records returned
        ...
        Returns
        -------
        List[prisma.types.MeetingGroupByOutput]
            A list of dictionaries representing the Meeting record,
            this will also have additional fields present if aggregation arguments
            are used (see the above parameters)
        ...
        -------
        ```py
        # group Meeting records by invite_link values
        # and count how many records are in each group
        results = await Meeting.prisma().group_by(
            ['invite_link'],
            count=True,
        )
        ```
...
class ParticipantActions(Generic[_PrismaModelT]):
    ...
    async def query_first(
        ...
        *args
        ...
        user = await Participant.prisma().query_first(
            'SELECT * FROM Participant WHERE meeting_id = $1',
            1860847622,
        )
        ```
        """
    ...
    async def create(
        ...
        participant = await Participant.prisma().create(
            data={
                ...
                'meeting_id': 1448521415,
                'display_name': 'bgcigfahea',
            },
        )
        ```
        """
        ...
        *,
        ...
        total = await Participant.prisma().create_many(
            data=[
                {
                    # data to create a Participant record
                    'meeting_id': 1249606685,
                    'display_name': 'idfjadbcc',
                },
                {
                    # data to create a Participant record
                    'meeting_id': 763719779,
                    'display_name': 'ecjjjfbae',
                },
            ],
            skip_duplicates=True,
        )
    ...
    async def find_many(
        ...
        # find the first 5 Participant records ordered by the user_id field
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second Participant record ordered by the display_name field
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Participant record ordered by the role field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Participant records by left_at values
        # and count how many records are in each group
...
class MessageActions(Generic[_PrismaModelT]):
    ...
    async def query_first(
        ...
        *args
        ...
        user = await Message.prisma().query_first(
            'SELECT * FROM Message WHERE meeting_id = $1',
            1583689592,
        )
        ```
        """
    ...
    async def create(
        ...
        message = await Message.prisma().create(
            data={
                ...
                'meeting_id': 878442065,
                'sender_name': 'bghfciaafe',
                'text': 'bgchfhgceh',
            },
        )
        ```
        ...
        *,
        ...
        total = await Message.prisma().create_many(
            data=[
                {
                    # data to create a Message record
                    'meeting_id': 2054802212,
                    'sender_name': 'gaddfhfh',
                    'text': 'gieegcbeg',
                },
                {
                    # data to create a Message record
                    'meeting_id': 1625503827,
                    'sender_name': 'fcbichhci',
                    'text': 'bcggadccgf',
                },
            ],
            skip_duplicates=True,
    ...
    async def find_many(
        ...
        # find the first 5 Message records ordered by the sender_name field
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second Message record ordered by the text field
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Message record ordered by the created_at field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Message records by text values
        # and count how many records are in each group
