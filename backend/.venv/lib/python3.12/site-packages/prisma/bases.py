...
class BaseMeeting(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Meeting']] = 'Meeting'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.MeetingActions[_PrismaModelT]':
        from .client import get_client

        return actions.MeetingActions[_PrismaModelT](client or get_client(), cls)


class BaseParticipant(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Participant']] = 'Participant'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.ParticipantActions[_PrismaModelT]':
        from .client import get_client

        return actions.ParticipantActions[_PrismaModelT](client or get_client(), cls)
