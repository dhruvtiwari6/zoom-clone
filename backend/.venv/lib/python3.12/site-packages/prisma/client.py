...
SCHEMA_PATH = Path('/home/dhruv-tiwari/.gemini/antigravity/scratch/zoom-clone/backend/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'debian-openssl-3.0.x': '/home/dhruv-tiwari/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-debian-openssl-3.0.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    meeting: 'actions.MeetingActions[models.Meeting]'
    ...
    def __init__(
        ...
        *,
        ...
        self.meeting = actions.MeetingActions[models.Meeting](self, models.Meeting)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': 'file:./zoom_clone.db', 'fromEnvVar': None}).resolve(),
            'source_file_path': '/home/dhruv-tiwari/.gemini/antigravity/scratch/zoom-clone/backend/schema.prisma',
        }
...
class Batch:
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.meeting = MeetingBatchActions(self)
